...
const TableTh = ({column, sortColumn, setSortColumn, setSortDirection, sortDirection = 'asc', children}) => {
    const handleSort = () => {
        let nextDirection;
    ...
    return (
        <th
            className={style.tableThContainer}
            onClick={handleSort}
        ...
        >
            <div className={style.container}>
              ...
              {isSorting && sortDirection === "asc" && <AiOutlineArrowUp className={style.icon} color="blue"/>}
                    {isSorting && sortDirection === "desc" && <AiOutlineArrowDown className={style.icon} color="blue"/>}
                    {!isSorting && (
                        <div>

...
const renderActiveShape = (props) => {
    ...
    return (
        <g>
            ...
            <text x={0} y={50} fill="#333">{`Зірочок ${value}`}</text>
            <text x={0} y={50} dy={18} fill="#999">
...
const LikeUnlikeChar = ({data, minWidth = 350, maxHeight = 250, colors}) => {
    const [selected, setSelected] = useState(0);
    return (
        <ResponsiveContainer minWidth={minWidth} maxHeight={maxHeight}>
            <PieChart>
                <Pie
